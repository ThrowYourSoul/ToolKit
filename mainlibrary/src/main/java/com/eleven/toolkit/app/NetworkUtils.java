...
public final class NetworkUtils {
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) ToolKit.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) ToolKit.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
