...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = ToolKit.getApp()
                    .getPackageManager()
                    .getPackageInfo(ToolKit.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private String  mLogSwitchFile     = "dbg.mm";// The file prefix of log.
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && ToolKit.getApp().getExternalCacheDir() != null)
                mDefaultDir = ToolKit.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            if (new File(Environment.getExternalStorageDirectory(),mLogSwitchFile).exists()){
                mLogSwitch=true;
            }

            else {
                mDefaultDir = ToolKit.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
//            Environment.get
//            if (new File("/sdcard/dbg.mm").exists()) {
//                debugMode = true;
//            } else {
//                debugMode = false;
//            }
        ...
        public Config setLogSwitchFileName(final String fileName) {
            mLogSwitchFile = fileName;
            return this;
        }
        ...
        public Config setStackOffset( final int stackOffset) {
        ...
        public String toString() {
            return "switch: " + mLogSwitch
                    + LINE_SEP + "mLogSwitchFile: " + mLogSwitchFile
